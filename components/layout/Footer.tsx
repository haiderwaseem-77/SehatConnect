      ...
      <div className="wrap">
        <div className="foot-top">
          <div className="foot-brand">
            ...
            <p data-ur className="ur urdu">PNC رجسٹرڈ نرسیں اور تربیت یافتہ اٹینڈنٹ، پورے لاہور میں۔ آنے سے پہلے شناختی کارڈ، حوالہ جات اور پولیس تصدیق چیک ہوتی ہے۔</p>
          </div>
          ...
          <div className="foot-col">
            ...
            <Link href="/services/qualified-nurse"><span data-en>Qualified nurse (PNC)</span><span data-ur className="urdu">نرس (PNC)</span></Link>
          ...
          <div className="foot-col">
            ...
            <Link href="/#faq"><span data-en>Questions families ask</span><span data-ur className="urdu">گھر والوں کے سوال</span></Link>
          </div>
          <div className="foot-col">
            <h4><span data-en>We serve all Lahore</span><span data-ur className="urdu">ہم پورے لاہور میں آتے ہیں</span></h4>
            ...
            <p className="areas">
              ...
              <span data-ur className="urdu">ڈی ایچ اے &middot; گلبرگ &middot; جوہر ٹاؤن &middot; ماڈل ٹاؤن &middot; بحریہ ٹاؤن &middot; کینٹ، اور آس پاس۔</span>
            </p>
          </div>
        </div>
