      ...
      <div className="wrap">
        <div className="sec-head" data-reveal>
          ...
          <h2>
            ...
            <span data-ur className="urdu">طریقہ آسان ہے: صرف تین قدم۔</span>
          </h2>
          <p>
            <span data-en>From your first call to care at home, we keep the next step simple.</span>
            <span data-ur className="urdu">پہلی کال سے گھر پر دیکھ بھال تک، ہم ہر قدم واضح رکھتے ہیں۔</span>
          </p>
        </div>
        <ol className="steps">
          <li className="step" data-reveal>
            <div className="step-top">
              ...
              <h3>
                ...
                <span data-ur className="urdu">بتائیں دیکھ بھال کس کو چاہیے</span>
              </h3>
            </div>
            <p>
              <span data-en>Leave your name and phone, or call or WhatsApp. Tell us what your loved one needs at home.</span>
              <span data-ur className="urdu">اپنا نام اور نمبر چھوڑ دیں، یا کال/واٹس ایپ کریں۔ ہمیں بتائیں گھر پر کیا ضرورت ہے۔</span>
            </p>
          </li>
          <li className="step" data-reveal>
            <div className="step-top">
            ...
            <p>
              ...
              <span data-ur className="urdu">ہم واپس کال کر کے صورتحال سمجھتے ہیں، پھر نرس یا اٹینڈنٹ کا مناسب بندوبست کرتے ہیں۔</span>
            </p>
          </li>
          <li className="step" data-reveal>
            <div className="step-top">
              ...
              <h3>
                ...
                <span data-ur className="urdu">دیکھ بھال گھر پہنچ جاتی ہے</span>
              </h3>
            </div>
            <p>
              <span data-en>Your nurse or attendant arrives at the agreed time. First day is free.</span>
              <span data-ur className="urdu">نرس یا اٹینڈنٹ طے شدہ وقت پر پہنچتا ہے۔ پہلا دن مفت ہے۔</span>
            </p>
            <span className="step-wa">
              ...
              <span>
                ...
                <span data-ur className="urdu">جب نرس یا اٹینڈنٹ راستے میں ہو تو ہم واٹس ایپ پر اطلاع دے دیتے ہیں۔</span>
              </span>
            </span>
          </li>
        </ol>
