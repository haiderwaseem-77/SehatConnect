      ...
      <div className="wrap">
        <div className="closer-grid">
          <div className="closer-copy">
            ...
            <p className="closer-urdu urdu" data-en>فکر یہاں ختم — سکون یہاں شروع۔</p>
            <div className="closer-actions">
              ...
              <a className="btn btn-ghost" href={`tel:${CONTACT_PHONE_TEL}`} style={{ color: "#fff", borderColor: "rgba(255,255,255,.3)" }}>
                ...
                <span data-en>Call {CONTACT_PHONE_DISPLAY}</span><span data-ur className="urdu">کال {CONTACT_PHONE_DISPLAY}</span>
              </a>
            </div>
          </div>
