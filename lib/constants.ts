...
export const QUALIFIED_NURSE_SERVICES = [
  ...
  { id: 'mother_baby_care', label: 'Mother & Baby Care', urdu: 'ماں اور بچے کی دیکھ بھال', icon: 'Baby',     description: 'Postnatal support for the mother after delivery — wound care, medicines, rest and hygiene at home', descriptionUrdu: 'زچگی کے بعد ماں کی دیکھ بھال — زخم، دوائیں، آرام اور صفائی' },
  ...
  { id: 'palliative_care', label: 'Palliative & Long-term Care', urdu: 'طویل مدتی آرام دہ نگہداشت', icon: 'HandHeart', description: 'Day-to-day nursing for cancer, stroke and long-term patients, carrying out the care the doctor has written down', descriptionUrdu: 'کینسر، فالج اور طویل بیماری کے مریضوں کی روزمرہ نرسنگ، ڈاکٹر کی ہدایت کے مطابق' },
];
